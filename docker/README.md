## BOSSS XDR Server Docker image

This directory contains the instructions and resources used to assemble a Docker image for the BOSSS XDR Server, which can be used as the base for other developments and projects.
